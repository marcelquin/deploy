...
function Localizacao() {
    ...
    return (
        <div className='conteudoLocalizacao'>
            ...
            <h1>Localizações Disponíveis</h1><br/>
            <div class="input-group mb-3">
            <button class="btn btn-outline-secondary" type="button" id="button-addon1"></button>
            <input type="text" class="form-control" name='pesquisaInput' onChange={handleChange} placeholder="Digite o nome a ser pesquisado" aria-label="Example text with button addon" aria-describedby="button-addon1"/>
            </div> 
